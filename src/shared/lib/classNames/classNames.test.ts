...
describe('classNames', () => {
    ...
    test('with 3 and more mods', () => {
        const expected = 'someClass class1 class2 hovered scrollable active';
        expect(classNames('someClass', { hovered: true, scrollable: true, active: true }, ['class1', 'class2'])).toBe(expected);
    });
});
